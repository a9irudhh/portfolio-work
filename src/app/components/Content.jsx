...
export default function Content() {
  const sections = [
    {
      ...
      component: (
        <Skills cards={["Skill 1", "Skill 2", "Skill 3", "Skill 4", "Skill 5", "Skill 6"]} />
      ),
    },
    {
  ...
  return (
    <div className="flex flex-col items-center gap-20 px-0 sm:px-6 md:px-12 lg:px-20 xl:px-32 mt-12 sm:mt-16 w-full box-border">
